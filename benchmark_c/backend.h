...
const bench_backend *backend_lightrt_qtri_q16(void); /* quantized leaf q16 */
const bench_backend *backend_lightrt_qtri_q8(void);  /* quantized leaf q8  */
const bench_backend *backend_lightrt_qtri_fp8(void); /* quantized leaf fp8 */
const bench_backend *backend_lightrt_qtri_fp4(void); /* quantized leaf fp4 */
